...
class PlayerAnalyzerWindowTests(unittest.TestCase):
    def test_largest_qualifying_window_prefers_biggest_n(self) -> None:
        # Qualifies at n=6 (5/6), fails at n=7 (5/7), qualifies again at n=8 (6/8).
        values = [1, 1, 1, 1, 0, 1, 0, 1]

        best = _largest_qualifying_window(values, threshold=1)

        self.assertEqual(best, (6, 8))
    ...
    def test_qualifying_hits_uses_largest_window_per_threshold(self) -> None:
        ...
        self.assertEqual([(h.threshold, h.wins, h.total) for h in hits], [(1, 7, 8), (2, 6, 8)])
    ...
    def test_regression_user_reported_examples_match_recent_window_logic(self) -> None:
        ...
        self.assertEqual(_largest_qualifying_window(buendia_fouls_committed, threshold=1), (9, 12))
        self.assertEqual(_largest_qualifying_window(rogers_sot, threshold=1), (6, 8))
        self.assertEqual(_largest_qualifying_window(rogers_shots, threshold=2), (14, 18))
