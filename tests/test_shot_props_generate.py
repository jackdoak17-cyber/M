...
class ShotPropsGenerateTests(unittest.TestCase):
    ...
    def test_recent_started_samples_caps_to_ten_starts(self) -> None:
        raw_values = list(range(12))
        raw_minutes = [90] * 12
        ...
        self.assertEqual(starts[-1], (9, 90))
    ...
    def test_verify_post_matches_candidates_detects_missing_line(self) -> None:
        ...
        broken_hp_post = hp_post.replace("→ Player B (Team B) won in 9/10 @1.45\n", "", 1)
