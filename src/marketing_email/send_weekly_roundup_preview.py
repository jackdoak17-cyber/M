...
def render_text(site_url: str | None) -> str:
    ...
    return "\n".join(
        [
            ...
            "",
            "Premier League fixture board preview, one marquee fixture deep dive, and example strategy outputs from OddsSearch.",
            "",
            "Open the fixture board:",
            f"{root_url}/fixtures",
            "",
            "Included in this issue:",
            "- Upcoming Premier League weekend fixtures",
            "- Liverpool vs Man City fixture deep dive",
            "- Example 1+ shot on target strategy",
            "- Over 1.5 goals strategy output",
            "- Double chance strategy output",
            "",
            "Build a strategy:",
            f"{root_url}/members/search-builder",
            "",
